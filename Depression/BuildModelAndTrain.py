...
model.compile(optimizer=adam_optimizer, loss='categorical_crossentropy', metrics=[AUC(), Precision(), Recall(), 'accuracy'])

model.fit(x=x_train, y=y_train_encoded, batch_size=3, epochs=10, verbose=2, validation_split=.2)
