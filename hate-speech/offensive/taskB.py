...
task_dataset_cols = ['tweet','hs_label']
tweet_col_index = 0
label_col_index = 1
...
train_df.loc[train_df[task_dataset_cols[label_col_index]] == 'HS1', task_dataset_cols[label_col_index]] = 1
train_df.loc[train_df[task_dataset_cols[label_col_index]] == 'HS2', task_dataset_cols[label_col_index]] = 1
train_df.loc[train_df[task_dataset_cols[label_col_index]] == 'HS3', task_dataset_cols[label_col_index]] = 1
train_df.loc[train_df[task_dataset_cols[label_col_index]] == 'HS5', task_dataset_cols[label_col_index]] = 1
train_df.loc[train_df[task_dataset_cols[label_col_index]] == 'HS6', task_dataset_cols[label_col_index]] = 1
train_df.loc[train_df[task_dataset_cols[label_col_index]] == 'NOT_HS', task_dataset_cols[label_col_index]] = 0
train_df[task_dataset_cols[label_col_index]] = train_df[task_dataset_cols[label_col_index]].astype(np.float64)

val_df.loc[val_df[task_dataset_cols[label_col_index]] == 'HS1', task_dataset_cols[label_col_index]] = 1
val_df.loc[val_df[task_dataset_cols[label_col_index]] == 'HS2', task_dataset_cols[label_col_index]] = 1
val_df.loc[val_df[task_dataset_cols[label_col_index]] == 'HS3', task_dataset_cols[label_col_index]] = 1
val_df.loc[val_df[task_dataset_cols[label_col_index]] == 'HS4', task_dataset_cols[label_col_index]] = 1
val_df.loc[val_df[task_dataset_cols[label_col_index]] == 'HS5', task_dataset_cols[label_col_index]] = 1
val_df.loc[val_df[task_dataset_cols[label_col_index]] == 'HS6', task_dataset_cols[label_col_index]] = 1
val_df.loc[val_df[task_dataset_cols[label_col_index]] == 'NOT_HS', task_dataset_cols[label_col_index]] = 0
