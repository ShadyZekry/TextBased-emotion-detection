...
train_df = pd.read_csv('./result/augmented_offensive_data.csv', usecols=['tweet']).dropna()
...
save_train_features(train_features, 'offensive')
save_val_features(val_features, 'offensive')
