...
class BertUtilities:
    ...
    def __init__(self, task: str, dataset_name: str, bert_path: str, tokenizer_path: str, sequence_length_mode: str, dataset_path: str, text_col : str, label_col : str, memory_threshold_percentage = 1.0, save_embeddings = False, encoding='utf-8') -> None:
        ...
        self.__task = task
        self.__dataset = pd.read_csv(dataset_path, usecols=[text_col, label_col], encoding=encoding)
    ...
    def get_labels(self) -> np.ndarray:
        """get_labels:\n
            gets the labels column as a numpy array from the dataset.\n
            returns: ndarray.
        """
        return self.__dataset[self.__label_col].to_numpy()
